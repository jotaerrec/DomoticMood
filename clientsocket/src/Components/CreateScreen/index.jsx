...
export const HomeCard = () => {
    ...
    useEffect(async () => {
        const tokenTemp = await JSON.parse(localStorage.getItem('x-access-token'));
        setToken(tokenTemp);
    })
    ...
    return (
        <>
            <div>
                ...
                <li>
                    <input type="text" value={data.typeUse} placeholder="Type the use..." />
                </li>
                <li>
                    <input type="text" value={data.room} placeholder="Room..." />
                </li>
                <button type="submit" onSubmit={createPin}>Submit</button>
            </div>
        </>
    );
};
